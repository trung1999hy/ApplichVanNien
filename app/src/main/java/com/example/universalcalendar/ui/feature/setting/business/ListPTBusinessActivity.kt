...
import com.example.universalcalendar.ui.feature.setting.festival.FestivalDetailActivity
import com.example.universalcalendar.ui.feature.setting.festival.FestivalViewModel
import com.example.universalcalendar.ui.feature.setting.festival.ListFestivalActivity

class ListPTBusinessActivity : BaseActivity<ActivityListVowsBinding>(), OnClickItem<PTBusiness> {
    companion object {
    ...
    override fun onClick(data: PTBusiness) {
        val intent = Intent(this, DetailPTBusinessActivity::class.java).apply {
            val bundle = Bundle()
